...
public class SeparationRecipes {
    ...
    public static void init(Consumer<FinishedRecipe> provider) {
        ...
        CENTRIFUGE_RECIPES.recipeBuilder("oilsands_ore_separation")
                ...
                .chancedYieldOutput(new ItemStack(Blocks.SAND), 7500)
        ...
        CENTRIFUGE_RECIPES.recipeBuilder("sticky_resin_separation").duration(400).EUt(5)
                ...
                .chancedYieldOutput(PLANT_BALL.asStack(), 1500)
        ...
        CENTRIFUGE_RECIPES.recipeBuilder("rubber_log_separation").duration(200).EUt(5)
                ...
                .chancedYieldOutput(STICKY_RESIN.asStack(), 6400)
                .chancedYieldOutput(PLANT_BALL.asStack(), 4000)
                .chancedYieldOutput(dust, Carbon, 3000)
                .chancedYieldOutput(dust, Wood, 3000)
        ...
        CENTRIFUGE_RECIPES.recipeBuilder("dirt_separation").duration(250).EUt(VA[LV])
                ...
                .chancedYieldOutput(PLANT_BALL.asStack(), 1400)
                .chancedYieldOutput(new ItemStack(Blocks.SAND), 6000)
                .chancedYieldOutput(dust, Clay, 550)
                .save(provider);

        CENTRIFUGE_RECIPES.recipeBuilder("grass_block_separation").duration(250).EUt(VA[LV])
                .inputItems(Blocks.GRASS_BLOCK.asItem())
                .chancedYieldOutput(PLANT_BALL.asStack(), 3500)
                .chancedYieldOutput(new ItemStack(Blocks.SAND), 5500)
                .chancedYieldOutput(dust, Clay, 550)
                .save(provider);

        CENTRIFUGE_RECIPES.recipeBuilder("mycelium_separation").duration(650).EUt(VA[LV])
                .inputItems(new ItemStack(Blocks.MYCELIUM))
                .chancedYieldOutput(new ItemStack(Blocks.RED_MUSHROOM), 2800)
                .chancedYieldOutput(new ItemStack(Blocks.BROWN_MUSHROOM), 2800)
                .chancedYieldOutput(new ItemStack(Blocks.SAND), 6200)
                .chancedYieldOutput(dust, Clay, 550)
                .save(provider);

        CENTRIFUGE_RECIPES.recipeBuilder("ash_separation").duration(240).EUt(VA[LV])
                .inputItems(dust, Ash)
                .chancedYieldOutput(dust, Quicklime, 4950)
                .chancedYieldOutput(dust, Potash, 1600)
                .chancedYieldOutput(dust, Magnesia, 1500)
                .chancedYieldOutput(dust, PhosphorusPentoxide, 60)
                .chancedYieldOutput(dust, SodaAsh, 600)
                .chancedYieldOutput(dust, Hematite, 275)
                .save(provider);
        ...
        CENTRIFUGE_RECIPES.recipeBuilder("uranium_238_separation").duration(800).EUt(320)
                ...
                .chancedYieldOutput(dustTiny, Plutonium239, 280)
                .chancedYieldOutput(dustTiny, Uranium235, 2300)
                .save(provider);

        CENTRIFUGE_RECIPES.recipeBuilder("plutonium_239_separation").duration(1600).EUt(320)
                .inputItems(dust, Plutonium239)
                .chancedYieldOutput(dustTiny, Uranium238, 3400)
                .chancedYieldOutput(dust, Plutonium241, 2500)
                .save(provider);

        CENTRIFUGE_RECIPES.recipeBuilder("endstone_separation").duration(320).EUt(20)
                .inputItems(dust, Endstone)
                .chancedYieldOutput(new ItemStack(Blocks.SAND), 9000)
                .chancedYieldOutput(dust, Tungstate, 445)
                .chancedYieldOutput(dust, Platinum, 80)
        ...
        CENTRIFUGE_RECIPES.recipeBuilder("netherrack_separation").duration(160).EUt(20)
                ...
                .chancedYieldOutput(dust, Redstone, 700)
                .chancedYieldOutput(dust, Gold, 75)
                .chancedYieldOutput(dust, Sulfur, 2500)
                .chancedYieldOutput(dust, Coal, 700)
                .save(provider);

        CENTRIFUGE_RECIPES.recipeBuilder("soul_sand_separation").duration(200).EUt(80)
                .inputItems(Blocks.SOUL_SAND.asItem())
                .chancedYieldOutput(new ItemStack(Blocks.SAND), 9250)
                .chancedYieldOutput(dust, Saltpeter, 2250)
                .chancedYieldOutput(dust, Coal, 225)
        ...
        CENTRIFUGE_RECIPES.recipeBuilder("lava_separation").duration(80).EUt(80)
                ...
                .chancedYieldOutput(dust, SiliconDioxide, 1250)
                .chancedYieldOutput(dust, Magnesia, 250)
                .chancedYieldOutput(dust, Quicklime, 250)
                .chancedYieldOutput(nugget, Gold, 250)
                .chancedYieldOutput(dust, Sapphire, 315)
                .chancedYieldOutput(dust, Tantalite, 125)
                .save(provider);

        CENTRIFUGE_RECIPES.recipeBuilder("rare_earth_separation").duration(64).EUt(20)
                .inputItems(dust, RareEarth)
                .chancedYieldOutput(dustSmall, Cadmium, 3500)
                .chancedYieldOutput(dustSmall, Neodymium, 4500)
                .chancedYieldOutput(dustSmall, Samarium, 3500)
                .chancedYieldOutput(dustSmall, Cerium, 5500)
                .chancedYieldOutput(dustSmall, Yttrium, 3500)
                .chancedYieldOutput(dustSmall, Lanthanum, 2500)
                .save(provider);

        CENTRIFUGE_RECIPES.recipeBuilder("red_sand_separation").duration(50).EUt(VA[LV])
                .inputItems(Blocks.RED_SAND.asItem())
                .chancedYieldOutput(dust, Iron, 5000)
                .chancedYieldOutput(dust, Diamond, 35)
                .chancedYieldOutput(new ItemStack(Blocks.SAND), 8500)
                .save(provider);
        ...
        CENTRIFUGE_RECIPES.recipeBuilder("stone_dust_separation").duration(480).EUt(VA[MV])
                ...
                .chancedYieldOutput(dust, Quartzite, 2500)
                .chancedYieldOutput(dust, PotassiumFeldspar, 2500)
                .chancedYieldOutput(dust, Marble, "2/9")
                .chancedYieldOutput(dust, Biotite, "1/9")
                .chancedYieldOutput(dust, MetalMixture, 925)
                .chancedYieldOutput(dust, Sodalite, 650)
                .save(provider);

        CENTRIFUGE_RECIPES.recipeBuilder("metal_mixture_separation").duration(1000).EUt(900)
                .inputItems(dust, MetalMixture)
                .chancedYieldOutput(dust, Hematite, 2500)
                .chancedYieldOutput(dust, Bauxite, 2500)
                .chancedYieldOutput(dust, Pyrolusite, "2/9")
                .chancedYieldOutput(dust, Barite, "1/9")
                .chancedYieldOutput(dust, Chromite, 855)
                .chancedYieldOutput(dust, Ilmenite, 575)
                .save(provider);
        ...
        CENTRIFUGE_RECIPES.recipeBuilder("quartz_sand_separation").duration(60).EUt(VA[LV])
                ...
                .chancedYieldOutput(dust, CertusQuartz, 2500)
                .save(provider);
